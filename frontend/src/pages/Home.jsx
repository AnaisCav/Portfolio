...
const Home = () => {
  return (
    <div id="home" className="leading-relaxed">
      <div className="bg-blue-bg leading-relaxed py-16">
        <div className="text-gray-100 flex flex-col items-center justify-center mx-4 md:mx-6 lg:mx-56 ">
